...
off: invoke `engineering:using-requirements-gathering` and drive it (it self-drives the
interrogation and writes the requirements, brief.md §1–§6, into this run's `triage/`
