...
if grep -rIl "NOTICE" "$d/../skills/codebase-design" "$d/../skills/domain-modeling" "$d/../skills/tdd" "$d/../skills/diagnosing-bugs" "$d/../skills/code-review" "$d/../skills/improve-codebase-architecture" 2>/dev/null; then
