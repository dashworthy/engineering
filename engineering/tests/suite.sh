...
sh "$d/validate.sh"
for name in signal triage receiving-code-review implement vernacular handoff wait-what to-spec interrogating-requirements clarifying-docblocks rewriting-docblock-prose; do
