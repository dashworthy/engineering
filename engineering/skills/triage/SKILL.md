...
**bisect by domain concept** (not by line number; use the domain names the code and the
report already establish for the area), **check for redundancy** (the reported
