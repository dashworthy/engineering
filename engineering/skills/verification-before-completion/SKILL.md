...
description: "[Foundation] Before claiming done, fixed, or passing, run the verification commands and confirm their output — show the proof, don't just assert it. Use whenever you're about to report success. Complements test-hardening (which hardens the tests themselves)."
---
