...
Say this first, plainly: `Using the code-review accessibility facet to review this change.`
...
- It does not **run a scanner** — no axe-core, no browser, no linter; it reasons statically about
  the diff-visible markup, the way every code-review facet reasons structurally.
