...
Say this first, plainly: `Using the code-review Electron facet to review this change.`
...
- It does not **build or run the app** — no `electron .`, no packaging, no fuzzing; it reasons
  statically about the diff-visible code, the way every code-review facet reasons structurally.
