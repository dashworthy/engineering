...
| Facets | `skills/code-review/references/facets/<facet>/facet.md` | One review lens each (15 today; some facets carry more than one sub-lens under one relevance gate). A facet's own doc is read only when it is dispatched — never merely to decide whether to run it. |
