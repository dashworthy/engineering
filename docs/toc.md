...
| [Spec ledger](pipeline/spec-ledger/README.md) | The committed record of every approved spec — a frozen spec.md written at approval and a companion retro.md written at ship, one dated directory per run under docs/specs/ | pipeline |
