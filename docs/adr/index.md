...
| 0004 | Bound every guardtower facet's analysis to the diff plus model knowledge | Designing or changing a guardtower facet's detection depth / analysis scope (reuse, coupling, data-safety reachability, API-consumer discovery) | Accepted | [0004](0004-guardtower-facets-bound-analysis-to-the-diff.md) |
