...
| 0004 | Own design-pattern guidance in codebase-design, split selectable matrix from evaluative lens | Adding or organizing design-pattern / SOLID / anti-pattern guidance in the design phase; deciding where pattern-selection guidance lives | Accepted | [0004](0004-own-design-pattern-guidance-in-codebase-design.md) |
